...
export function DashboardPendingStatsCard(props) {
  ...
  return (
    <DashboardStatsCardLayout
      icon={<DashboardStatsCardLayout.Icon iconType={RefreshDouble} />}
      headline={<DashboardStatsCardLayout.Headline label="Pending" />}
      count={
